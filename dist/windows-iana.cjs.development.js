...
var IANA_ALIAS_MAP = [{
  ...
  "alias": ["Australia/Hobart", "Australia/Tasmania", "Australia/Currie"]
}, {
  "name": "auldc",
  ...
  "alias": ["America/Edmonton", "Canada/Mountain", "America/Yellowknife"]
}, {
  "name": "cafne",
  ...
  "alias": ["America/Iqaluit", "America/Pangnirtung"]
}, {
  "name": "camon",
  ...
  "alias": ["America/Toronto", "America/Montreal", "Canada/Eastern", "America/Nipigon", "America/Thunder_Bay"]
}, {
  "name": "cavan",
  ...
  "alias": ["America/Winnipeg", "Canada/Central", "America/Rainy_River"]
}, {
  "name": "caybx",
  ...
  "alias": ["Pacific/Enderbury", "Pacific/Kanton"]
}, {
  "name": "kitrw",
  ...
  "alias": ["America/Tijuana", "America/Ensenada", "Mexico/BajaNorte", "America/Santa_Isabel"]
}, {
  "name": "mykch",
  ...
  "alias": ["Europe/Kiev", "Europe/Kyiv", "Europe/Zaporozhye", "Europe/Uzhgorod"]
}, {
  "name": "uasip",
  ...
  "alias": ["Pacific/Honolulu", "US/Hawaii", "Pacific/Johnston"]
}, {
  "name": "usind",
...
var WINDOWS_TO_IANA_MAP = [{
  ...
  "windowsName": "Central Standard Time",
  "territory": "MX",
  "iana": ["America/Matamoros", "America/Ojinaga"]
}, {
  "windowsName": "Central Standard Time",
  "territory": "US",
  ...
  "windowsName": "Central Standard Time (Mexico)",
  "territory": "MX",
  "iana": ["America/Mexico_City", "America/Bahia_Banderas", "America/Merida", "America/Monterrey", "America/Chihuahua", ""]
}, {
...
function findWindows(ianaTimeZone) {
  ...
  var result = new Set();
  WINDOWS_TO_IANA_MAP.filter(function (it) {
    return it.iana.find(function (it) {
      return aliases.includes(it);
    });
...
exports.IANA_ALIAS_MAP = IANA_ALIAS_MAP;
exports.WINDOWS_TO_IANA_MAP = WINDOWS_TO_IANA_MAP;
exports.findIana = findIana;
exports.findIanaAliases = findIanaAliases;
exports.findWindows = findWindows;
//# sourceMappingURL=windows-iana.cjs.development.js.map
